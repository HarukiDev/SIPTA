...
export default function IpkBox({ totalsks, metodologi, kkn, ipk, s1, s2, s3, s4, s5, s6, s7, s8}) {
    return (
        <div className="flex flex-col bg-primary rounded-lg px-16 pt-5 pb-10 ml-5">
            ...
            <div className="flex flex-row gap-5 flex-wrap flex-auto text-center auto-cols-max mt-5">
                <div>
                    ...
                    <p className="font-semibold text-lg">{s1}</p>
                </div>
                <div>
                    ...
                    <p className="font-semibold text-lg">{s2}</p>
                </div>
                <div>
                    <div className="flex px-2 py-0 mb-1 bg-neutral rounded-box text-neutral-content">
                        <span className="font-bold font-mono text-3xl p-3 ">
                    ...
                    <p className="font-semibold text-lg">{s3}</p>
                </div>
                <div>
                    <div className="flex px-2 py-0 mb-1 bg-neutral rounded-box text-neutral-content">
                        <span className="font-bold font-mono text-3xl p-3 ">
                    ...
                    <p className="font-semibold text-lg">{s4}</p>
                </div>
                <div>
                    <div className="flex px-2 py-0 mb-1 bg-neutral rounded-box text-neutral-content">
                        <span className="font-bold font-mono text-3xl p-3 ">
                    ...
                    <p className="font-semibold text-lg">{s5}</p>
                </div>
                <div>
                    <div className="flex px-2 py-0 mb-1 bg-neutral rounded-box text-neutral-content">
                        <span className="font-bold font-mono text-3xl p-3 ">
                    ...
                    <p className="font-semibold text-lg">{s6}</p>
                </div>
                <div>
                    <div className="flex px-2 py-0 mb-1 bg-neutral rounded-box text-neutral-content">
                        <span className="font-bold font-mono text-3xl p-3 ">
                    ...
                    <p className="font-semibold text-lg">{s7}</p>
                </div>
                <div>
                    <div className="flex px-2 py-0 mb-1 bg-neutral rounded-box text-neutral-content">
                        <span className="font-bold font-mono text-3xl p-3 ">
                    ...
                    <p className="font-semibold text-lg">{s8}</p>
                </div>
            </div>
        </div>
    );
